   ...
   for info in json_info:
    if info['type']=='recent_add':
     ...
     if seasons:
      ...
      include_parent=e if o(seasons)>1 else t
      for s in seasons:
 ...
 def make_list(data,root,videos,info,channel_title,include_parent=t):
  ...
  for tag_video in videos:
   ...
   try:
    ...
    channel_tag.set('id',I(LogicM3U.channel_index))
    ...
    display_name_tag.text=I(LogicM3U.channel_index)
    ...
    for i in X(3):
     ...
     program_tag.set('channel',I(LogicM3U.channel_index))
