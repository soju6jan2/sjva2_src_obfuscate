...
def streaming(contenttype,contentid,quality,credential,action='hls',ishevc='y',isabr='y',proxy=k):
 if quality=='FHD':
  quality='1080p'
 elif quality=='HD':
  quality='720p'
...
def streaming_imsi(contenttype,contentid,quality,credential,action='hls',ishevc='y',isabr='y',proxy=k):
 if quality=='FHD':
  quality='1080p'
 elif quality=='HD':
  quality='720p'
