...
def get_guid():
 ...
 m.update(uuid)
 return j(m.hexdigest())
def streaming(contenttype,contentid,quality,credential,action='hls',ishevc='y',isabr='y',proxy=C):
 if quality=='FHD':
  quality='1080p'
 elif quality=='HD':
  quality='720p'
...
def streaming_imsi(contenttype,contentid,quality,credential,action='hls',ishevc='y',isabr='y',proxy=C):
 if quality=='FHD':
  quality='1080p'
 elif quality=='HD':
  quality='720p'
