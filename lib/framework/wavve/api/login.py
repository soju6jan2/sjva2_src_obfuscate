...
def do_login(P,pw,json_return=B):
 try:
  body={"type":"general","id":P,"pushid":"","password":pw,"profile":"0","networktype":"","carrier":"","mcc":"","mnc":"","markettype":"unknown","adid":"","simoperator":"","installerpackagename":""}
