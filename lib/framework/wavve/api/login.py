...
def do_login(Y,pw,json_return=K):
 try:
  body={"type":"general","id":Y,"pushid":"","password":pw,"profile":"0","networktype":"","carrier":"","mcc":"","mnc":"","markettype":"unknown","adid":"","simoperator":"","installerpackagename":""}
