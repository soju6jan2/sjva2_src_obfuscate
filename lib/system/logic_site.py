...
class SystemLogicSite(d):
 ...
 def get_daum_cookie_by_selenium(notify=w):
  try:
   ...
   if notify:
    ...
    socketio.emit("notify",data,namespace='/framework',broadcast=m) 
 ...
 def get_daum_cookies(force=w):
  try:
   if SystemLogicSite.daum_cookie is R or force:
    ret={}
